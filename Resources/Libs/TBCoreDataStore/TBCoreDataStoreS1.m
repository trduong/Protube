...
static NSString *const TBCoreDataModelFileName = @"ProTubeClone";
...
{
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SaleModel.sqlite"];
